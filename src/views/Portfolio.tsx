...
const Portfolio: React.FC = () => {
    ...
    const [demoImg, setDemoImg] = useState(["1", "2", "3", "4", "5", "6", "7", "8", "9"])
            ...
            <BodyPage>
                <WrapperContent>
                    ...
                    <div style={{ textAlign: "center", paddingTop: "30px", paddingBottom: "30px" }}>
                        ...
                        <Row gutter={12} style={{ paddingTop: "20px", paddingBottom: "20px" }}>
                            {demoImg.map((detailImg) => {
                                return (
                                    <Col span={24} lg={8} style={{ marginTop: "30px" }}>
                                        <ImageCover src="https://os.alipayobjects.com/rmsportal/QBnOOoLaAfKPirc.png" onClick={() => alert(detailImg)} />
                                    </Col>
                                )
                            })}
                        </Row>
