                    ...
                    <div style={{ textAlign: "center", paddingTop: "20px" }}>
                        ...
                        <Person>
                            <PersonalDetail style={{ textAlign: "right" }}>
                                ...
                                <h3>
                                    กรรมการบริษัท, ผู้จัดการฝ่ายบริหาร
                                    </h3>
                            </PersonalDetail>
                            <ImageCover src="https://os.alipayobjects.com/rmsportal/QBnOOoLaAfKPirc.png" />
                        </Person>
                        <TextOther>
                            <h1>
                                <span style={{ color: "#843A39", fontWeight: "bold" }}>“ </span>พร้อมทั้งทีมงานที่มากประสบการณ์
                                </h1>
                            <h1>
                                กว่า 10 ปี อีกหลายชีวิต<span style={{ color: "#843A39", fontWeight: "bold" }}> “</span>
                            </h1>
                        </TextOther>
                    </div>
                </WrapperContent>
